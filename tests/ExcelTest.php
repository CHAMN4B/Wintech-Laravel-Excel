...
use WintechLaravel\Excel\Concerns\WithCustomCsvSettings;
use WintechLaravel\Excel\Concerns\WithEvents;
use WintechLaravel\Excel\Excel;
use WintechLaravel\Excel\Facades\Excel as ExcelFacade;
use WintechLaravel\Excel\Importer;
use WintechLaravel\Excel\Tests\Data\Stubs\EmptyExport;
use WintechLaravel\Excel\Tests\Helpers\FileHelper;
...
class ExcelTest extends TestCase
{
    ...
    {
        $this->expectException(\WintechLaravel\Excel\Exceptions\ConcernConflictException::class);
    ...
    {
        $this->expectException(\WintechLaravel\Excel\Exceptions\NoTypeDetectedException::class);
