...
use WintechLaravel\Excel\Fakes\ExcelFake;
use WintechLaravel\Excel\Tests\Data\Stubs\ChainedJobStub;
...
class ExcelFakeTest extends TestCase
{
    ...
    public function test_can_assert_against_a_fake_raw_export()
    {
        ...
        $response = ExcelFacade::raw($this->givenExport(), \WintechLaravel\Excel\Excel::XLSX);
