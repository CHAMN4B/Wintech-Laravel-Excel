...
use WintechLaravel\Excel\Concerns\WithHeadingRow;
...
use WintechLaravel\Excel\Validators\ValidationException;
...
class WithValidationTest extends TestCase
{
    ...
    public function test_can_validate_rows()
    {
        $import = new class implements ToModel, WithValidation
        {
            ...
            {
                return [
                    '1' => Rule::in(['patrick@wintechlaravel.nl']),
                ];
            }
        };
            ...
            public function rules(): array
            {
                return [
                    '1' => function ($attribute, $value, $onFail) {
                        if ($value !== 'patrick@wintechlaravel.nl') {
            ...
            public function rules(): array
            {
                return [
                    '1' => new class implements \Illuminate\Contracts\Validation\Rule
                    {
                        ...
                        {
                            return $value === 'patrick@wintechlaravel.nl';
                        }
    ...
    public function test_can_validate_rows_with_conditionality()
    {
        $import = new class implements ToModel, WithValidation
        {
            ...
            {
                return [
                    'conditional_required_column' => 'required_if:1,patrick@wintechlaravel.nl',
                ];
            }
        };
        ...
        try {
            ...
            $this->validateFailure($e, 1, 'conditional_required_column', [
                'The conditional_required_column field is required when 1.1 is patrick@wintechlaravel.nl.',
            ]);
        }
    ...
    public function test_can_validate_rows_with_unless_conditionality()
    {
        $import = new class implements ToModel, WithValidation
        {
            ...
            {
                return [
                    'conditional_required_unless_column' => 'required_unless:1,patrick@wintechlaravel.nl',
                ];
            }
        };
        ...
        try {
            ...
            $this->validateFailure($e, 2, 'conditional_required_unless_column', [
                'The conditional_required_unless_column field is required unless 2.1 is in patrick@wintechlaravel.nl.',
            ]);
        }
    ...
    public function test_can_validate_rows_with_headings()
    {
        $import = new class implements ToModel, WithHeadingRow, WithValidation
        {
            ...
            {
                return [
                    'email' => Rule::in(['patrick@wintechlaravel.nl']),
                ];
            }
        };
    ...
    public function test_can_configure_validator()
    {
        $import = new class implements ToModel, WithValidation
        {
            ...
            {
                $validator->sometimes('*.1', Rule::in(['patrick@wintechlaravel.nl']), function () {
                    return true;
                });
            }
        };
