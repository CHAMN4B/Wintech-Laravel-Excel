...
use WintechLaravel\Excel\Exporter;
...
class ExportableTest extends TestCase
{
    ...
    {
        $this->expectException(\WintechLaravel\Excel\Exceptions\NoFilenameGivenException::class);
    ...
    {
        $this->expectException(\WintechLaravel\Excel\Exceptions\NoFilePathGivenException::class);
